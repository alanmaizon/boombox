...
class TestGmailMock:
    def test_list_messages_returns_mock(self) -> None:
        from backend.mcp.mcp_clients import gmail_list_messages
...
class TestDriveMock:
    def test_upload_returns_mock(self) -> None:
        from backend.mcp.mcp_clients import drive_upload_file
    ...
    def test_get_file_returns_mock(self) -> None:
        from backend.mcp.mcp_clients import drive_get_file
...
class TestSheetsMock:
    def test_append_rows_returns_mock(self) -> None:
        from backend.mcp.mcp_clients import sheets_append_rows
...
class TestCalendarMock:
    def test_create_event_returns_mock(self) -> None:
        from backend.mcp.mcp_clients import calendar_create_event
