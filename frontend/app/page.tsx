export default function Home() {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-2xl font-normal mb-2">Boombox</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <a
          href="/income"
          className="block p-6 border border-gray-200 p-6 hover:border-black transition-colors group hover:bg-gray-50 transition-colors"
        >
          <h2 className="text-lg font-normal mb-2">Income</h2>
        ...
        <a
          ...
          className="block p-6 border border-gray-200 p-6 hover:border-black transition-colors group hover:bg-gray-50 transition-colors"
        >
          <h2 className="text-lg font-normal mb-2">Expenses</h2>
          <p className="text-gray-600 text-sm">
        ...
        <a
          ...
          className="block p-6 border border-gray-200 p-6 hover:border-black transition-colors group hover:bg-gray-50 transition-colors"
        >
          <h2 className="text-lg font-normal mb-2">Mileage</h2>
          <p className="text-gray-600 text-sm">
        ...
        <a
          ...
          className="block p-6 border border-gray-200 p-6 hover:border-black transition-colors group hover:bg-gray-50 transition-colors"
        >
          <h2 className="text-lg font-normal mb-2">Calculate</h2>
          <p className="text-gray-600 text-sm">
        ...
        <a
          ...
          className="block p-6 border border-gray-200 p-6 hover:border-black transition-colors group hover:bg-gray-50 transition-colors"
        >
          <h2 className="text-lg font-normal mb-2">Filing</h2>
          <p className="text-gray-600 text-sm">
        ...
        <a
          ...
          className="block p-6 border border-gray-200 p-6 hover:border-black transition-colors group hover:bg-gray-50 transition-colors"
        >
          <h2 className="text-lg font-normal mb-2">Advisory</h2>
          <p className="text-gray-600 text-sm">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-sm text-yellow-800">
        <strong>Important:</strong> Boombox is an educational and
